...
#### Note: Use this client library with InfluxDB 2.x and InfluxDB 1.8+. For connecting to InfluxDB 1.7 or earlier instances, please use the [influxdb-php](https://github.com/influxdata/influxdb-php) client library.
