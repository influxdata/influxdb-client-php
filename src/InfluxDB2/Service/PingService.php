...
class PingService
{
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function headPingAsync()
    {
        return $this->headPingAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation headPingAsyncWithHttpInfo
     *
     * Checks the status of InfluxDB instance and version of InfluxDB.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function headPingAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->headPingRequest();
