...
class TelegrafPluginsService
{
    ...
    public function getTelegrafPluginsWithHttpInfo($zap_trace_span = null, $type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\InfluxDB2\Model\TelegrafPlugins' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\InfluxDB2\Model\TelegrafPlugins', []),
    ...
    /**
     * Operation getTelegrafPluginsAsync
     *
     * List all Telegraf plugins
     *
     * @param  string $zap_trace_span OpenTracing span context (optional)
     ...
     */
    public function getTelegrafPluginsAsync($zap_trace_span = null, $type = null)
    {
        return $this->getTelegrafPluginsAsyncWithHttpInfo($zap_trace_span, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTelegrafPluginsAsyncWithHttpInfo
     *
     * List all Telegraf plugins
     *
     * @param  string $zap_trace_span OpenTracing span context (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTelegrafPluginsAsyncWithHttpInfo($zap_trace_span = null, $type = null)
    {
        $returnType = '\InfluxDB2\Model\TelegrafPlugins';
        $request = $this->getTelegrafPluginsRequest($zap_trace_span, $type);
