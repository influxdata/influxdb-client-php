...
class Task implements ModelInterface, ArrayAccess
{
     ...
     * Sets type
     *
     * @param string|null $type The type of task, this can be used for filtering tasks on list actions.
     *
     * @return $this
     */
     ...
     * Sets org_id
     *
     * @param string $org_id The ID of the organization that owns this Task.
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param string|null $offset Duration to delay after the schedule, before executing the task; parsed from flux, if set to zero it will remove this option and use 0 as the default.
     *
     * @return $this
     */
