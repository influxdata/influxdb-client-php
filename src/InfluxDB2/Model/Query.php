...
class Query implements ModelInterface, ArrayAccess
{
     ...
     * Sets params
     *
     * @param map[string,object]|null $params Enumeration of key/value pairs that respresent parameters to be injected into query (can only specify either this field or extern and not both)
     *
     * @return $this
     */
     ...
     * Sets now
     *
     * @param \DateTime|null $now Specifies the time that should be reported as "now" in the query. Default is the server's now time.
     *
     * @return $this
     */
