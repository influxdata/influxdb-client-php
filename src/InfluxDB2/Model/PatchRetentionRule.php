...
class PatchRetentionRule implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['every_seconds']) && ($this->container['every_seconds'] < 0)) {
     ...
     * Sets every_seconds
     *
     * @param int|null $every_seconds Duration in seconds for how long data will be kept in the database. 0 means infinite.
     *
     * @return $this
     */
    public function setEverySeconds($every_seconds)
    {
        ...
        if (!is_null($every_seconds) && ($every_seconds < 0)) {
