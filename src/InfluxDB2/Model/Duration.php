...
class Duration implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['magnitude'] = isset($data['magnitude']) ? $data['magnitude'] : null;
    ...
    {
        return $this->container['magnitude'];
    }

    /**
     * Sets magnitude
     *
     * @param int|null $magnitude magnitude
     *
     * @return $this
     */
    public function setMagnitude($magnitude)
    {
        $this->container['magnitude'] = $magnitude;
