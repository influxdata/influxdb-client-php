...
/**
 * MetadataBackup Class Doc Comment
 *
 * @category Class
 * @package  InfluxDB2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MetadataBackup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetadataBackup';
    ...
    protected static $openAPITypes = [
        'kv' => '\SplFileObject',
        'sql' => '\SplFileObject',
        'buckets' => '\InfluxDB2\Model\BucketMetadataManifest[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['kv'] === null) {
            $invalidProperties[] = "'kv' can't be null";
        }
     ...
     * Gets buckets
     *
     * @return \InfluxDB2\Model\BucketMetadataManifest[]
     */
     ...
     * Sets buckets
     *
     * @param \InfluxDB2\Model\BucketMetadataManifest[] $buckets buckets
     *
     * @return $this
     */
