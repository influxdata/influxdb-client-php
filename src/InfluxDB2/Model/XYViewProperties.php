...
class XYViewProperties extends ViewProperties 
{
    ...
    protected static $openAPITypes = [
        ...
        'color_mapping' => 'map[string,string]',
        'shape' => 'string',
        'note' => 'string',
    ...
    {
        return $this->container['color_mapping'];
    }

    /**
     * Sets color_mapping
     *
     * @param map[string,string]|null $color_mapping A color mapping is an object that maps time series data to a UI color scheme to allow the UI to render graphs consistent colors across reloads.
     *
     * @return $this
     */
    public function setColorMapping($color_mapping)
    {
        $this->container['color_mapping'] = $color_mapping;
