...
/**
 * SimpleTableViewProperties Class Doc Comment
 *
 * @category Class
 * @package  InfluxDB2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SimpleTableViewProperties extends ViewProperties 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimpleTableViewProperties';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : TYPE_SIMPLE_TABLE;
        $this->container['show_all'] = isset($data['show_all']) ? $data['show_all'] : null;
