...
/**
 * ReplicationCreationRequest Class Doc Comment
 *
 * @category Class
 * @package  InfluxDB2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ReplicationCreationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReplicationCreationRequest';
    ...
    public function setMaxQueueSizeBytes($max_queue_size_bytes)
    {
        ...
        if (($max_queue_size_bytes < 33554430)) {
            throw new \InvalidArgumentException('invalid value for $max_queue_size_bytes when calling ReplicationCreationRequest., must be bigger than or equal to 33554430.');
        }
    ...
    public function setMaxAgeSeconds($max_age_seconds)
    {
        ...
        if (($max_age_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_age_seconds when calling ReplicationCreationRequest., must be bigger than or equal to 0.');
        }
