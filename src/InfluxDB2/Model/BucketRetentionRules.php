 ...
 * @link     https://openapi-generator.tech
 */
class BucketRetentionRules implements ModelInterface, ArrayAccess
{
     ...
     * Sets every_seconds
     *
     * @param int $every_seconds The duration in seconds for how long data will be kept in the database. The default duration is 2592000 (30 days). 0 represents infinite retention.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $shard_group_duration_seconds The shard group duration. The duration or interval (in seconds) that each shard group covers.  #### InfluxDB Cloud  - Does not use `shardGroupDurationsSeconds`.  #### InfluxDB OSS  - Default value depends on the [bucket retention period](https://docs.influxdata.com/influxdb/v2.3/v2.3/reference/internals/shards/#shard-group-duration).
     *
     * @return $this
     */
