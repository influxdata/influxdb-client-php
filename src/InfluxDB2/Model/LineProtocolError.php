...
class LineProtocolError implements ModelInterface, ArrayAccess
{
     ...
     * Sets op
     *
     * @param string $op Op describes the logical code operation during error. Useful for debugging.
     *
     * @return $this
     */
     ...
     * Sets err
     *
     * @param string $err Err is a stack of errors that occurred during processing of the request. Useful for debugging.
     *
     * @return $this
     */
     ...
     * Sets line
     *
     * @param int|null $line First line within sent body containing malformed data
     *
     * @return $this
     */
