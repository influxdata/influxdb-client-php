...
/**
 * LineProtocolError Class Doc Comment
 *
 * @category Class
 * @package  InfluxDB2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class LineProtocolError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LineProtocolError';
     ...
     * Sets op
     *
     * @param string|null $op Describes the logical code operation when the error occurred. Useful for debugging.
     *
     * @return $this
     */
     ...
     * Sets err
     *
     * @param string|null $err Stack of errors that occurred during processing of the request. Useful for debugging.
     *
     * @return $this
     */
     ...
     * Sets line
     *
     * @param int|null $line First line in the request body that contains malformed data.
     *
     * @return $this
     */
