...
class Axis implements ModelInterface, ArrayAccess
{
     ...
     * Sets bounds
     *
     * @param string[]|null $bounds The extents of an axis in the form [lower, upper]. Clients determine whether bounds are to be inclusive or exclusive of their limits
     *
     * @return $this
     */
