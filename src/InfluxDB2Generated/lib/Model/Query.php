...
class Query implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'query' => 'string',
        'spec' => '\InfluxDB2Generated\Model\QuerySpecification',
        'type' => 'string',
        'db' => 'string',
        'rp' => 'string',
        'cluster' => 'string',
     ...
     * Gets spec
     *
     * @return \InfluxDB2Generated\Model\QuerySpecification|null
     */
     ...
     * Sets spec
     *
     * @param \InfluxDB2Generated\Model\QuerySpecification|null $spec spec
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string|null $type type of query
     *
     * @return $this
     */
