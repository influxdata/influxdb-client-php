...
class HealthApi
{
     ...
     */
    public function healthGet($zap_trace_span = null)
    {
        list($response) = $this->healthGetWithHttpInfo($zap_trace_span);
        return $response;
    }
     ...
     */
    public function healthGetWithHttpInfo($zap_trace_span = null)
    {
        $request = $this->healthGetRequest($zap_trace_span);
     ...
     */
    public function healthGetAsync($zap_trace_span = null)
    {
        return $this->healthGetAsyncWithHttpInfo($zap_trace_span)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function healthGetAsyncWithHttpInfo($zap_trace_span = null)
    {
        $returnType = '\InfluxDB2Generated\Model\Check';
        $request = $this->healthGetRequest($zap_trace_span);
     ...
     */
    protected function healthGetRequest($zap_trace_span = null)
    {
